...
angular.module('streama').factory('apiService', function ($http, $rootScope, contextPath) {
    ...
    subscription: {
        createUserSubscription: function(planName){
            return $http.post('kbSubscribe/subscribeUser.json', {params: {planName: planName}});
        },
        createUserSubscription1: function(planName){
            return $http.post('kbSubscribe/subscribeUser1.json', {params: {planName: planName}});
        },
        createUserSubscription2: function(planName){
            return $http.post('kbSubscribe/subscribeUser1.json', {params: {planName: planName}});
        },
        getUserSubscription: function(){
            return $http.get('kbSubscribe/getUserSubscription.json');
        },
        cancelUserSubscription: function(){
            return $http.get('kbSubscribe/cancelUserSubscription.json');
        }
    },
    account: {
        getUserAccount: function() {
          return $http.get('kbAccount/getUserAccount.json');
        },
        getUserAccountBalance: function () {
          return $http.get('kbAccount/getUserAccountBalance.json');
        },
        getUserOverdueStatus: function () {
          return $http.get('kbAccount/getUserOverdueStatus.json');
        }
    }
}
});
